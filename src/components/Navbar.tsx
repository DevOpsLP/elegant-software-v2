...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-transform duration-300 ease-in-out bg-primary-100  shadow-md ${isVisible ? "translate-y-0" : "-translate-y-full"
        }`}
    >
